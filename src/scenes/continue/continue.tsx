...
const Continue = () => {
  ...
  return  <section
  id="growthandfixed"
  className=" min-h-full w-full py-40 px-20  bg-bcg2">
      <motion.div 
        ...
        <HText> <span className="text-blueish">GROWTH VS FIXED</span> MINDSET </HText>
      ...
      <motion.div
            ...
            <div className="flex flex-col items-center text-center mt-20 text-yellow">
